...
<svg
  ...
  <g
    ...
    <p>Altitude de départ</p><p id="Altitude_Haut"></p>
    <p>Altitude de fin</p><p id="Altitude_Bas"></p>
    <p id='1'>Longueur</p><p id="Débit_Longueur"></p>
    <p id='2'>Largeur</p><p id="Largeur"></p>


  
    </main>
<footer>
        <p>Contact : <a href='mailto:gga.gski2020@gmail.com'>gga.gski2020@gmail.com</a> <br>Cette station est purement fictive et appartient au jeu <a href='https://g-ski.com/'>G-ski</a>, nous ne pouvons tenus être responsables de tout problème.</p>
